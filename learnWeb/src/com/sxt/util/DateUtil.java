 ...
 * @author pillar liu
 * @version $Id: DateUtil.java, v 0.1 2015-9-7 上午10:07:57 pillar liu $
 */
public class DateUtil {
    ...
    // 年月日
    public static final String sSimple = "yyyy/MM/dd";
    ...
    //完整时间2
    public static final String simple2          = "yyyy/MM/dd HH:mm:ss";

    //时间天数
    public static final int days31 = 31;
    public static final int days30 = 30;
    public static final int days29 = 29;
    public static final int days28 = 28;
     ...
     * @return
     */
    public static final String simpleFormat2(Date date) {
        if (date == null) {
            return "";
        }
    ...
    /**
     * yyyy/mm/dd hh24:mm:ss日期格式转换为日期
     * 
     * @param strDate
     * 
     * @return
     */
    public static final Date strToDtSimpleFormat2(String strDate) {
        if (strDate == null) {
            return null;
        }

        try {
            return getFormat(simple2).parse(strDate);
        } catch (Exception e) {
        }
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(getDateMill());
    ...
    public static final String getDateMill(){
	    Date d = new Date();
     ...
     * @return
     */
    public static int getNestDaysByMonth(Date date){
    	if (date == null) {
            return days31;
        }
    	Calendar calendar = Calendar.getInstance();
	 ...
	 * @return
	 */
	public static int getDaysByQuarter(Date date, int cycle){
	 ...
	 * @return
	 */
	public static int getNextDaysByQuarter(Date date, int cycle){
		Calendar startCalendar = Calendar.getInstance(); //得到日历
		startCalendar.setTime(date);
		startCalendar.add(Calendar.MONTH, cycle);
		Calendar endCalendar = Calendar.getInstance(); //得到日历
		endCalendar.setTime(date);
		endCalendar.add(Calendar.MONTH, 2*cycle);
		return (int) ((endCalendar.getTimeInMillis() - startCalendar.getTimeInMillis()) / (1000 * 60 * 60 * 24));
	}
