 ...
 * Page
 * pillar liu
 * 2015-10-12 下午5:44:53
 * @version 1.0.0
 */
public class Page<T> extends QueryResult<T> {
	// 公共变量
	public static final String ASC = "asc";
	public static final String DESC = "desc";

	public static final int MIN_PAGESIZE = 5;
	public static final int MAX_PAGESIZE = 22;
	...
	public void setPageNo(String pageNo) {
		if(StringUtils.isEmpty(pageNo) || "undefined".equalsIgnoreCase(pageNo) || Integer.parseInt(pageNo) < 1)
			this.pageNo = 1;
		else
	 ...
	 * 设置每页的记录数量,超出MIN_PAGESIZE与MAX_PAGESIZE范围时会自动调整.
	 */
	public void setPageSize2(final int pageSize) {
		this.pageSize = pageSize;
	}
