...
public interface IRepaymentDetail {
	public int fRepayPlan(int investor_id);
	
	public void finsertrepaydetail(RepaymentDetail repaymentdetail);
	
	public int insertRepaymentDetailBatch(List<RepaymentDetail> repaymentdetails);
	
	public Date fqueryprouid(Map<String,Object> param);
	...
	public void updateRepaymentDetailByMap(Map<String,Object> para);
